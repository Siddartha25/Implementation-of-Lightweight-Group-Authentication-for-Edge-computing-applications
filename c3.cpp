...
vector<string> my_y;
vector<string> my_x;
string publish_share(int id_gl=1,int id_grp=1,int id_node=3,string message="898998/1/2932-2175-9599-2403/d17f25ecfbcc7857f7bebea469308be0b2580943e96d13a3ad98a13675c4bfc2"){
...
string publish_if_selected(int id_node,int id_gl,int id_grp,string imessage="1-3/111020241247/32823e72783101bb7a46250af05c693ffd35179a82729d3df3defc626ad2cf24"){
    ...
    for(auto itr:nodes){
        if(itr==to_string(id_node)){
            s=to_string(id_gl)+"/"+to_string(id_grp)+"/"+to_string(id_node)+"/"+to_string(token[0])+"/"+split(split(first_message,'/')[2],'-')[2*id_node-2]; //when you are sending your pair you can send any one
        }
    }
    return s;
}
